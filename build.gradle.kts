...
val kgVer = "0.1.21" // https://central.sonatype.com/artifact/pl.mareklangiewicz/kground/versions
...
val details = myLibDetails(
  ...
  version = Ver(0, 4, 38), // https://plugins.gradle.org/search?term=pl.mareklangiewicz
