    ...
    "On clean gradle cache and build dir programmatically" o {
      ...
      "On task processExtensions1ByReg" o {
        ...
        "On gradle successful run" o {
          ...
          "On SpecialExtensions.kt content afterwards" o {
            ...
            testGeneratedFunctions(content)
          }
        }
...
private fun testGeneratedFunctions(content: String) = "On generated functions" o {
  val generated by ureRegion(ureWhateva().withName("generated"), "Generated Special Extensions")
    .findSingle(content).namedValues
  val ure = ure {
    +atBOLine
    +ureText("fun ")
    +ure("funName") {
  ...
  val funNames: List<String> = generated
    .chkNN { "region Generated Special Extensions not found" }
    .findAll(ure)
    .map { it.namedValues["funName"]!! }
    .toList()

  "there is two fun for each basic type" o { // except Byte which is not generated, but used as template
    listOf("Short", "Int", "Long", "Float", "Double", "Boolean", "Char").forEach { type ->
